...
//    {
//        return PlayerData.Instance.GetTotalKills(entry.chapterName) >= entry.killsNeededToUnlockName;
//    }

//    // check if image can be unlocked
//    public bool IsImageUnlocked(PageEntry entry)
//    {
//        return PlayerData.Instance.GetTotalKills(entry.chapterName) >= entry.killsNeededToUnlockImage;
//    }

//    // check if lore can be unlocked
//    public bool IsLoreUnlocked(PageEntry entry)
//    {
//        return PlayerData.Instance.GetTotalKills(entry.chapterName) >= entry.killsNeededToUnlockLore;
//    }

//    // overall percentage progress
//    public float GetUnlockProgress(PageEntry entry)
//    {
//        int currentKills = PlayerData.Instance.GetTotalKills(entry.chapterName);
