...
public class LevelSelectManager : MonoBehaviour
{
    ...
    //    enemiesText.text = GetEnemyListString(currentLevel.normalEnemies); 
    //    bossText.text = currentLevel.boss.bossName;
    //    superstitionText.text = currentLevel.superstition.name;
    //    rewardsText.text = currentLevel.endRewards.rewardAmount.ToString();
    //    mapText.text = currentLevel.map.name;
    //}
    ...
    public void StartGame(LevelData currentLevel)
    {
