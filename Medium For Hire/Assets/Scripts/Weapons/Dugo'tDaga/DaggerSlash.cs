...
public class DaggerSlash : MonoBehaviour
{
    ...
    [Header("REFERENCES")]
    private MainWeapon_Balarao weapon; // get stats from this
    ...
    //
    // *** CORE LOGIC
    private void Slash(Vector2 _position)
    {
        float slashRadius = weapon.finalRadius;
